...
#SBATCH -o ccv_log/mask_75.out
#SBATCH -e ccv_log/mask_75.err
...
python train.py --bs 256 --num_workers 32 --mask_ratio 0.75 --exp_name mask_75 --multi_view