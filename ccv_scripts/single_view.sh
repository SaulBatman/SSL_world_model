...
#SBATCH -o ccv_log/single_view.out
#SBATCH -e ccv_log/single_view.err
...
python train.py --bs 256 --num_workers 32 --mask_ratio 0.5 --exp_name single_view